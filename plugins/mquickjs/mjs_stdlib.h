...
static const uint64_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x000000746e697270,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "papagaio" (offset=544) */
  0x6f69616761706170,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "register" (offset=547) */
  0x7265747369676572,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (2 << (JS_MTAG_BITS + 3)), /* "gc" (offset=550) */
  0x0000000000006367,
  ...
  /* global object properties (offset=1943) */
...
const JSSTDLibraryDef mjs_stdlib = {
  js_stdlib_table,
  js_c_function_table,
